...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,created,modified,active,name,cpf,mobile_phone,zip_code,street,number,neighborhood,state,situation,income,description,institution_id);

@override
String toString() {
  return 'FamilyModel(id: $id, created: $created, modified: $modified, active: $active, name: $name, cpf: $cpf, mobile_phone: $mobile_phone, zip_code: $zip_code, street: $street, number: $number, neighborhood: $neighborhood, state: $state, situation: $situation, income: $income, description: $description, institution_id: $institution_id)';
}
...
@useResult
$Res call({
 int? id, DateTime? created, DateTime? modified, bool? active, String name, String cpf, String mobile_phone, String zip_code, String street, String number, String neighborhood, String state, String situation, String income, String description, int institution_id
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  DateTime? created,  DateTime? modified,  bool? active,  String name,  String cpf,  String mobile_phone,  String zip_code,  String street,  String number,  String neighborhood,  String state,  String situation,  String income,  String description,  int institution_id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FamilyModel() when $default != null:
return $default(_that.id,_that.created,_that.modified,_that.active,_that.name,_that.cpf,_that.mobile_phone,_that.zip_code,_that.street,_that.number,_that.neighborhood,_that.state,_that.situation,_that.income,_that.description,_that.institution_id);case _:
  return orElse();
...
class _FamilyModel implements FamilyModel {
  const _FamilyModel({this.id, this.created, this.modified, this.active, required this.name, required this.cpf, required this.mobile_phone, required this.zip_code, required this.street, required this.number, required this.neighborhood, required this.state, required this.situation, required this.income, required this.description, required this.institution_id});
